//
//  YXUserBehaviorAnalyzeManager.m
//  用户行为统计
//
...
#import "YXUserBehaviorAnalyzeManager.h"
...
static NSString *DBLogID = @"YXUserBehaviorMonitorManager";
static YXUserBehaviorAnalyzeManager *selfClass = nil;

@interface YXUserBehaviorAnalyzeManager (){
...
@implementation YXUserBehaviorAnalyzeManager

+ (instancetype)shareManager{
    static YXUserBehaviorAnalyzeManager *manager;
    static dispatch_once_t Token;
    dispatch_once (&Token,^{
        manager = [[YXUserBehaviorAnalyzeManager alloc] init];
